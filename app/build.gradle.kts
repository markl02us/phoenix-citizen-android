...
plugins {
    ...
    // Google services plugin (commented until Mark adds google-services.json)
    // id("com.google.gms.google-services")
}

// Load Maps API key from local.properties if present
...
dependencies {
    ...
    // Firebase (stubbed — Mark must add google-services.json)
